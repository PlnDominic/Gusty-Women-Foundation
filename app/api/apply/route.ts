      ...
      html: `
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto">
          <div style="background:#4a1a6e;padding:24px 32px">
            ...
            <p style="color:#c9a84c;margin:8px 0 0;font-size:13px;font-weight:600">GWF Mentorship Program Masterclass · Cohort 2</p>
          </div>
          <div style="padding:32px;border:1px solid #e5e7eb;border-top:none">
            ...
            <p style="font-size:15px;color:#374151;line-height:1.7;margin:16px 0 0">
              Thank you for applying to <strong>Cohort 2 of the GWF Mentorship Program Masterclass</strong>.
              We've received your application and are excited to learn more about you.
            </p>
            <p style="font-size:15px;color:#374151;line-height:1.7;margin:16px 0 0">
              Our team will review your application and be in touch by email with next steps.
              In the meantime, keep building and stay connected with us on social media.
            </p>
